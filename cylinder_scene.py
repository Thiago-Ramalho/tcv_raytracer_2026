...
from src.shapes import Cylinder, PlaneUV
...
class Scene(BaseScene):
    def __init__(self):
        ...
        # Position camera to have a good view of the cylinder(s)
        self.camera = Camera(
            eye=Vector3D(-4, -3, 2),
        ...
        # Test cylinder 1: Small blue cylinder (height = 1, radius = 0.5)
        blue_material = SimpleMaterial(
            ambient_coefficient=0.1,
            diffuse_coefficient=0.7,
            diffuse_color=Color(0.2, 0.2, 0.8),
